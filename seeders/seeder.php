...
try {
    ...
    if ($reset) {
        ...
        $pdo->exec("TRUNCATE TABLE achats RESTART IDENTITY CASCADE");
        $pdo->exec("TRUNCATE TABLE tranches RESTART IDENTITY CASCADE");
        $pdo->exec("TRUNCATE TABLE compteurs RESTART IDENTITY CASCADE");
        $pdo->exec("TRUNCATE TABLE clients RESTART IDENTITY CASCADE");
